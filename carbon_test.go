...
func TestAddYearsPositive(t *testing.T) {
	c := Create(2009, time.November, 10, 23, 0, 0, 0, time.UTC)

	d := c.AddYears(10)

	expected := Create(2019, time.November, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddYearsZero(t *testing.T) {
	...
	expected := Create(2009, time.November, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddYearsNegative(t *testing.T) {
	...
	expected := Create(1999, time.November, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddYear(t *testing.T) {
	...
	expected := Create(2010, time.November, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddQuartersPositive(t *testing.T) {
	...
	expected := Create(2010, time.May, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddQuartersNegative(t *testing.T) {
	...
	expected := Create(2009, time.May, 10, 23, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The Month should be equal to May")
}

func TestAddQuarter(t *testing.T) {
	c := Create(2010, time.January, 10, 23, 0, 0, 0, time.UTC)

	d := c.AddQuarter()

	expected := Create(2010, time.April, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddCenturiesPositive(t *testing.T) {
	...
	expected := Create(2310, time.January, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddCenturiesZero(t *testing.T) {
	...
	expected := Create(2010, time.January, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddCenturiesNegative(t *testing.T) {
	...
	expected := Create(1810, time.January, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddCentury(t *testing.T) {
	...
	expected := Create(2110, time.January, 10, 23, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The year should be equal 2110")
}
...
func TestAddMonthsPositive(t *testing.T) {
	...
	expected := Create(2010, time.March, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddMonthsNegative(t *testing.T) {
	...
	expected := Create(2009, time.October, 10, 23, 0, 0, 0, time.UTC)
...
func TestAddMonth(t *testing.T) {
	...
	expected := Create(2010, time.February, 10, 23, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The Month should be equal to February")
}

func TestAddSecondsPositive(t *testing.T) {
	c := Create(2010, time.January, 10, 22, 59, 0, 0, time.UTC)

	d := c.AddSeconds(70)

	expected := Create(2010, time.January, 10, 23, 0, 10, 0, time.UTC)
...
func TestAddSecondsNegative(t *testing.T) {
	...
	expected := Create(2010, time.January, 10, 22, 59, 40, 0, time.UTC)
...
func TestAddSecond(t *testing.T) {
	...
	expected := Create(2010, time.January, 10, 23, 0, 1, 0, time.UTC)
...
func TestAddDaysPositive(t *testing.T) {
	...
	expected := Create(2010, time.January, 20, 22, 59, 0, 0, time.UTC)
...
func TestAddDaysNegative(t *testing.T) {
	...
	expected := Create(2009, time.December, 31, 23, 0, 0, 0, time.UTC)
...
func TestAddDay(t *testing.T) {
	...
	expected := Create(2010, time.January, 11, 23, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The seconds should be equal to 11")
}

func TestAddWeekdaysPositive(t *testing.T) {
	c := Create(2016, time.August, 5, 10, 0, 0, 0, time.UTC)

	d := c.AddWeekdays(5)

	expected := Create(2016, time.August, 12, 10, 0, 0, 0, time.UTC)
...
func TestAddWeekdaysZero(t *testing.T) {
	...
	expected := Create(2016, time.August, 5, 10, 0, 0, 0, time.UTC)
...
func TestAddWeekdaysNegative(t *testing.T) {
	...
	expected := Create(2016, time.July, 29, 10, 0, 0, 0, time.UTC)
...
func TestAddWeekday(t *testing.T) {
	...
	expected := Create(2016, time.August, 8, 10, 0, 0, 0, time.UTC)
...
func TestAddWeeksPositive(t *testing.T) {
	...
	expected := Create(2016, time.August, 19, 10, 0, 0, 0, time.UTC)
...
func TestAddWeeksNegative(t *testing.T) {
	...
	expected := Create(2016, time.July, 22, 10, 0, 0, 0, time.UTC)
...
func TestAddHoursPositive(t *testing.T) {
	...
	expected := Create(2016, time.August, 5, 20, 0, 0, 0, time.UTC)
...
func TestAddHoursNegative(t *testing.T) {
	...
	expected := Create(2016, time.August, 4, 23, 0, 0, 0, time.UTC)
...
func TestAddHour(t *testing.T) {
	...
	expected := Create(2016, time.August, 5, 11, 0, 0, 0, time.UTC)
...
func TestAddMinutesPositive(t *testing.T) {
	...
	expected := Create(2016, time.August, 5, 10, 50, 0, 0, time.UTC)
...
func TestAddMinutesNegative(t *testing.T) {
	...
	expected := Create(2016, time.August, 5, 9, 10, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The minutes should be equal to 50")
}
...
func TestAddMinute(t *testing.T) {
	...
	expected := Create(2016, time.August, 5, 10, 1, 0, 0, time.UTC)
...
func TestAddMonthsNoOverflowPositive(t *testing.T) {
	c := Create(2016, time.January, 31, 10, 0, 0, 0, time.UTC)

	d := c.AddMonthsNoOverflow(2)

	expected := Create(2016, time.March, 31, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to March")
}

func TestAddMonthsNoOverflowPositiveWithOverflow(t *testing.T) {
	c := Create(2012, time.January, 31, 10, 0, 0, 0, time.UTC)

	d := c.AddMonthsNoOverflow(1)

	expected := Create(2012, time.February, 29, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to February")
}

func TestAddMonthsNoOverflowNegative(t *testing.T) {
	c := Create(2012, time.February, 29, 1, 0, 0, 0, time.UTC)

	d := c.AddMonthsNoOverflow(-2)

	expected := Create(2011, time.December, 29, 1, 0, 0, 0, time.UTC)
...
func TestAddMonthsNoOverflowNegativeWithOverflow(t *testing.T) {
	c := Create(2012, time.March, 31, 1, 0, 0, 0, time.UTC)

	d := c.AddMonthsNoOverflow(-1)

	expected := Create(2012, time.February, 29, 1, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to February")
}
...
func TestPreviousMonthLastDay(t *testing.T) {
	c := Create(2016, time.March, 31, 10, 0, 0, 0, time.UTC)

	d := c.PreviousMonthLastDay()

	expected := Create(2016, time.February, 29, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The day should be equal to 29")
}
...
func TestSubYearsZero(t *testing.T) {
	...
	expected := Create(2012, time.January, 31, 10, 0, 0, 0, time.UTC)
...
func TestSubYearsPositive(t *testing.T) {
	...
	expected := Create(2010, time.January, 31, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The year should be equal to 2010")
}
...
func TestSubYearsNegative(t *testing.T) {
	...
	expected := Create(2014, time.January, 31, 10, 0, 0, 0, time.UTC)
...
func TestSubYear(t *testing.T) {
	...
	expected := Create(2011, time.January, 31, 10, 0, 0, 0, time.UTC)
...
func TestSubQuartersPositive(t *testing.T) {
	...
	expected := Create(2011, time.July, 31, 10, 0, 0, 0, time.UTC)
...
func TestSubQuartersNegative(t *testing.T) {
	...
	expected := Create(2012, time.July, 31, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to July")
}
...
func TestSubQuarter(t *testing.T) {
	...
	expected := Create(2011, time.October, 31, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to October")
}
...
func TestSubCenturiesPositive(t *testing.T) {
	c := Create(1912, time.January, 31, 10, 0, 0, 0, time.UTC)

	d := c.SubCenturies(2)

	expected := Create(1712, time.January, 31, 10, 0, 0, 0, time.UTC)
...
func TestSubCenturiesNegative(t *testing.T) {
	...
	expected := Create(2112, time.January, 31, 10, 0, 0, 0, time.UTC)
...
func TestSubCentury(t *testing.T) {
	...
	expected := Create(1812, time.January, 31, 10, 0, 0, 0, time.UTC)
...
func TestSubMonthsPositive(t *testing.T) {
	...
	expected := Create(1911, time.November, 31, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to November")
}
...
func TestSubMonthsNegative(t *testing.T) {
	...
	expected := Create(1912, time.March, 31, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to March")
}
...
func TestSubMonth(t *testing.T) {
	...
	expected := Create(1911, time.December, 31, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to December")
}
...
func TestSubMonthsNoOverflowPositive(t *testing.T) {
	...
	expected := Create(1911, time.November, 30, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The month should be equal to November")
}
...
func TestSubDaysZero(t *testing.T) {
	...
	expected := Create(1912, time.January, 31, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The day should be equal to 31")
}
...
func TestSubDaysPositive(t *testing.T) {
	...
	expected := Create(1912, time.January, 21, 10, 0, 0, 0, time.UTC)
...
func TestSubDaysNegative(t *testing.T) {
	...
	expected := Create(1912, time.February, 10, 10, 0, 0, 0, time.UTC)
...
func TestSubDay(t *testing.T) {
	...
	expected := Create(1912, time.January, 30, 10, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The day should be equal to 30")
}

func TestSubWeekdayZero(t *testing.T) {
	c := Create(2016, time.August, 12, 10, 0, 0, 0, time.UTC)
...
func TestSubWeekday(t *testing.T) {
	c := Create(2016, time.August, 15, 10, 0, 0, 0, time.UTC)
...
func TestSubHoursPositive(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 0, 0, 0, 0, time.UTC)
...
func TestSubHoursNegative(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 20, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, d, "The hour should be equal to 20")
}
...
func TestSubHour(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 9, 0, 0, 0, time.UTC)
...
func TestSubMinutesPositive(t *testing.T) {
	c := Create(2016, time.August, 12, 10, 20, 0, 0, time.UTC)

	d := c.SubMinutes(10)

	expected := Create(2016, time.August, 12, 10, 10, 0, 0, time.UTC)
...
func TestSubMinutesNegative(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 10, 30, 0, 0, time.UTC)
...
func TestSubMinute(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 10, 19, 0, 0, time.UTC)
...
func TestSubSecondsPositive(t *testing.T) {
	c := Create(2016, time.August, 12, 10, 0, 30, 0, time.UTC)

	d := c.SubSeconds(10)

	expected := Create(2016, time.August, 12, 10, 0, 20, 0, time.UTC)
...
func TestSubSecondsNegative(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 10, 0, 40, 0, time.UTC)
	assert.Equal(t, expected, d, "The seconds should be equal to 40")
}
...
func TestSubSecond(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 10, 0, 29, 0, time.UTC)
...
func TestSetters(t *testing.T) {
	...
	expected := Create(2010, time.May, 2, 5, 10, 10, 0, time.UTC)
...
func TestSetDate(t *testing.T) {
	...
	expected := Create(2015, time.May, 30, 10, 0, 30, 0, time.UTC)
...
func TestSetTimeFromTimeStringMinute(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 20, 20, 30, 0, time.UTC)
...
func TestSetTimeFromTimeStringSecond(t *testing.T) {
	...
	expected := Create(2016, time.August, 12, 20, 20, 20, 0, time.UTC)
...
func TestSetTimestamp(t *testing.T) {
	...
	expected := Create(2007, time.February, 15, 1, 25, 25, 0, time.UTC)
...
func TestFormattedDateString(t *testing.T) {
	c := Create(2016, time.August, 2, 10, 0, 30, 0, time.UTC)
...
func TestDayDateTimeString(t *testing.T) {
	c := Create(2016, time.August, 8, 1, 0, 30, 0, time.UTC)

	assert.Equal(t, "Mon, Aug 8, 2016 1:00 AM", c.DayDateTimeString())
}

func TestAtomString(t *testing.T) {
	c := Create(2016, time.August, 1, 1, 0, 30, 0, time.UTC)

	assert.Equal(t, "2016-08-01T01:00:30+00:00", c.AtomString())
}

func TestCookieString(t *testing.T) {
	c := Create(2005, time.August, 15, 15, 52, 1, 0, time.UTC)
...
func TestRfc822String(t *testing.T) {
	c := Create(2016, time.August, 1, 15, 28, 21, 0, time.UTC)
...
func TestIsWeekendTrue(t *testing.T) {
	c := Create(2016, time.August, 14, 15, 28, 21, 0, time.UTC)

	assert.True(t, c.IsWeekend())
}

func TestIsWeekendFalse(t *testing.T) {
	c := Create(2016, time.August, 17, 15, 28, 21, 0, time.UTC)
...
func TestIsSameAsTrue(t *testing.T) {
	c := Create(2009, time.November, 10, 23, 0, 0, 0, time.UTC)
	d := Create(2009, time.November, 10, 23, 0, 0, 0, time.UTC)
...
func TestIsSameAsFalse(t *testing.T) {
	c := Create(2009, time.November, 10, 23, 0, 0, 0, time.UTC)
	d := Create(2009, time.November, 11, 23, 0, 0, 0, time.UTC)
...
func TestIsSameYearTrue(t *testing.T) {
	c := Create(2009, time.November, 10, 23, 0, 0, 0, time.UTC)
	d := Create(2009, time.January, 10, 23, 0, 0, 0, time.UTC)
...
func TestIsSameYearFalse(t *testing.T) {
	c := Create(2009, time.November, 10, 23, 0, 0, 0, time.UTC)
	d := Create(2019, time.January, 10, 23, 0, 0, 0, time.UTC)

	assert.False(t, c.IsSameYear(d))
}

func TestIsSameYearNil(t *testing.T) {
	c := Create(1970, time.November, 10, 23, 0, 0, 0, time.UTC)
...
func TestIsSameMonthSameYearFalse(t *testing.T) {
	c := Create(2009, time.November, 10, 23, 0, 0, 0, time.UTC)
	d := Create(2019, time.November, 10, 23, 0, 0, 0, time.UTC)
...
func TestIsSundayTrue(t *testing.T) {
	c := Create(2016, time.August, 14, 23, 0, 0, 0, time.UTC)

	assert.True(t, c.IsSunday())
}

func TestIsSundayFalse(t *testing.T) {
	c := Create(2016, time.August, 15, 23, 0, 0, 0, time.UTC)
...
func TestIsMondayFalse(t *testing.T) {
	c := Create(2016, time.August, 16, 23, 0, 0, 0, time.UTC)
...
func TestIsTuesdayFalse(t *testing.T) {
	c := Create(2016, time.August, 17, 23, 0, 0, 0, time.UTC)
...
func TestIsWednesdayFalse(t *testing.T) {
	c := Create(2016, time.August, 18, 23, 0, 0, 0, time.UTC)
...
func TestIsThursdayFalse(t *testing.T) {
	c := Create(2016, time.August, 19, 23, 0, 0, 0, time.UTC)
...
func TestIsFridayFalse(t *testing.T) {
	c := Create(2016, time.August, 20, 23, 0, 0, 0, time.UTC)
...
func TestIsSaturdayFalse(t *testing.T) {
	c := Create(2016, time.August, 21, 23, 0, 0, 0, time.UTC)
...
func TestEqTrue(t *testing.T) {
	c := Create(2016, time.August, 21, 23, 0, 0, 0, time.UTC)
	d := Create(2016, time.August, 21, 23, 0, 0, 0, time.UTC)
...
func TestEqFalse(t *testing.T) {
	c := Create(2015, time.August, 21, 23, 0, 0, 0, time.UTC)
	d := Create(2016, time.August, 21, 23, 0, 0, 0, time.UTC)
...
func TestNeTrue(t *testing.T) {
	c := Create(2016, time.August, 21, 23, 0, 0, 0, time.UTC)
	d := Create(2015, time.August, 21, 23, 0, 0, 0, time.UTC)
...
func TestParse(t *testing.T) {
	...
	expected := Create(2015, time.November, 2, 16, 10, 22, 0, loc)
...
func TestDiffInSecondsTimeZoneSameTime(t *testing.T) {
	...
	t2 := Create(2016, time.August, 18, 12, 0, 0, 0, loc)
...
func TestDiffInSecondsTimeZoneDifferentTime(t *testing.T) {
	loc, _ := time.LoadLocation("Europe/Madrid")
	t1 := Create(2016, time.August, 18, 10, 0, 0, 0, time.UTC)
	t2 := Create(2016, time.August, 18, 13, 0, 0, 0, loc)
...
func TestDiffInDaysTimeZone2(t *testing.T) {
	loc, _ := time.LoadLocation("Europe/Madrid")
	t1 := Create(2016, time.August, 18, 10, 0, 0, 0, time.UTC)
	t2 := Create(2016, time.August, 13, 12, 0, 0, 0, loc)
...
func TestDiffInWeeksTimeZone2(t *testing.T) {
	loc, _ := time.LoadLocation("Europe/Madrid")
	t1 := Create(2016, time.August, 18, 10, 0, 0, 0, time.UTC)
	t2 := Create(2016, time.July, 29, 12, 0, 0, 0, loc)
...
func TestDiffInYears(t *testing.T) {
	t1 := Create(2016, time.August, 18, 10, 0, 0, 0, time.UTC)
	t2 := Create(1016, time.July, 29, 12, 0, 0, 0, time.UTC)
...
func TestDiffInMonthsTimeZone(t *testing.T) {
	loc, _ := time.LoadLocation("Europe/Madrid")
	t1 := Create(2016, time.August, 18, 10, 0, 0, 0, time.UTC)
	t2 := Create(2016, time.January, 18, 12, 0, 0, 0, loc)
...
func TestDiffInMonths(t *testing.T) {
	t1 := Create(2016, time.August, 18, 10, 0, 0, 0, time.UTC)
	t2 := Create(2015, time.July, 29, 12, 0, 0, 0, time.UTC)
...
func TestDiffInWeekdaysOnWeekend(t *testing.T) {
	t1 := Create(2016, time.August, 20, 10, 0, 0, 0, time.UTC)
	t2 := Create(2016, time.August, 21, 10, 0, 0, 0, time.UTC)
...
func TestDiffInWeekendDaysOnWeekendNegative(t *testing.T) {
	t1 := Create(2016, time.August, 21, 10, 0, 0, 0, time.UTC)
	t2 := Create(2016, time.August, 20, 10, 0, 0, 0, time.UTC)
...
func TestDiffInDaysFiltered(t *testing.T) {
	t1 := Create(2000, time.January, 1, 0, 0, 0, 0, time.UTC)
	t2 := Create(2000, time.January, 31, 0, 0, 0, 0, time.UTC)
	f := func(c *Carbon) bool {
		return c.Weekday() == time.Sunday
	}
...
func TestDiffInDaysFilteredNegative(t *testing.T) {
	t1 := Create(2000, time.January, 31, 0, 0, 0, 0, time.UTC)
	t2 := Create(2000, time.January, 1, 0, 0, 0, 0, time.UTC)
	f := func(c *Carbon) bool {
		return c.Weekday() == time.Sunday
	}
...
func TestDiffInHoursFiltered(t *testing.T) {
	t1 := Create(2000, time.January, 1, 0, 0, 0, 0, time.UTC)
	t2 := Create(2000, time.January, 31, 23, 59, 59, 0, time.UTC)
	f := func(c *Carbon) bool {
		return c.Hour() == 9
	}
...
func TestDiffInHoursFilteredNegative(t *testing.T) {
	t1 := Create(2000, time.January, 31, 23, 59, 59, 0, time.UTC)
	t2 := Create(2000, time.January, 1, 0, 0, 0, 0, time.UTC)
	f := func(c *Carbon) bool {
		return c.Hour() == 9
	}
...
func TestStartOfDay(t *testing.T) {
	t1 := Create(2009, time.August, 31, 13, 0, 0, 0, time.UTC)
	t2 := t1.StartOfDay()

	expected := Create(2009, time.August, 31, 0, 0, 0, 0, time.UTC)
...
func TestEndOfDay(t *testing.T) {
	...
	expected := Create(2009, time.August, 31, 23, 59, 59, 999999999, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestStartOfMonth(t *testing.T) {
	t1 := Create(2009, time.August, 24, 13, 0, 0, 0, time.UTC)
	t2 := t1.EndOfMonth()
...
func TestStartOfQuarter(t *testing.T) {
	...
	expected := Create(2009, time.July, 1, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestEndOfQuarter(t *testing.T) {
	t1 := Create(2009, time.January, 24, 13, 0, 0, 0, time.UTC)
	t2 := t1.EndOfQuarter()

	expected := Create(2009, time.March, 31, 23, 59, 59, 999999999, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestStartOfYear(t *testing.T) {
	...
	expected := Create(2009, time.January, 1, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestEndOfYear(t *testing.T) {
	...
	expected := Create(2009, time.December, 31, 23, 59, 59, 999999999, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestStartOfDecade(t *testing.T) {
	t1 := Create(2006, time.August, 24, 13, 0, 0, 0, time.UTC)
	t2 := t1.StartOfDecade()

	expected := Create(2000, time.January, 1, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestEndOfCentury(t *testing.T) {
	...
	expected := Create(2099, time.December, 31, 23, 59, 59, 999999999, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestStartOfWeek(t *testing.T) {
	t1 := Create(2016, time.August, 24, 13, 0, 0, 0, time.UTC)
	t2 := t1.StartOfWeek()

	expected := Create(2016, time.August, 22, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestEndOfWeek(t *testing.T) {
	...
	expected := Create(2016, time.August, 28, 23, 59, 59, 999999999, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestNextWeekday(t *testing.T) {
	t1 := Create(2016, time.August, 19, 13, 0, 0, 0, time.UTC)
	t2 := t1.NextWeekday()

	expected := Create(2016, time.August, 22, 13, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestPreviousWeekday(t *testing.T) {
	t1 := Create(2016, time.August, 22, 13, 0, 0, 0, time.UTC)
	t2 := t1.PreviousWeekday()

	expected := Create(2016, time.August, 19, 13, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestNextWeekendDay(t *testing.T) {
	t1 := Create(2016, time.August, 18, 13, 0, 0, 0, time.UTC)
	t2 := t1.NextWeekendDay()

	expected := Create(2016, time.August, 20, 13, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestNextWeekendDayOnWeekend(t *testing.T) {
	t1 := Create(2016, time.August, 20, 13, 0, 0, 0, time.UTC)
	t2 := t1.NextWeekendDay()

	expected := Create(2016, time.August, 21, 13, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestPreviousWeekendDay(t *testing.T) {
	t1 := Create(2016, time.August, 23, 13, 0, 0, 0, time.UTC)
...
func TestFirstWednesdayOfMonth(t *testing.T) {
	...
	expected := Create(2016, time.August, 3, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestFirstMondayOfMonth(t *testing.T) {
	...
	expected := Create(2016, time.August, 1, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestLastWednesdayOfMonth(t *testing.T) {
	...
	expected := Create(2016, time.August, 31, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestLastSundayOfMonth(t *testing.T) {
	...
	expected := Create(2016, time.August, 28, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestSecondModayOfMonth(t *testing.T) {
	...
	expected := Create(2016, time.August, 8, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestFirstModayOfQuarter(t *testing.T) {
	...
	expected := Create(2016, time.July, 4, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestFirstDayOfQuarter(t *testing.T) {
	...
	expected := Create(2016, time.July, 1, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestLastDayOfQuarter(t *testing.T) {
	...
	expected := Create(2016, time.September, 30, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestLastMondayOfQuarter(t *testing.T) {
	...
	expected := Create(2016, time.September, 26, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestThirdFridayOfQuarter(t *testing.T) {
	...
	expected := Create(2016, time.July, 15, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestFirstDayOfYear(t *testing.T) {
	...
	expected := Create(2016, time.January, 1, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestFirstThursdayOfYear(t *testing.T) {
	...
	expected := Create(2016, time.January, 7, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestLastFridayOfYear(t *testing.T) {
	...
	expected := Create(2016, time.December, 30, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestLastMondayOfYear(t *testing.T) {
	...
	expected := Create(2016, time.December, 26, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestLastDayOfYear(t *testing.T) {
	...
	expected := Create(2016, time.December, 31, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestThirdModayOfYear(t *testing.T) {
	...
	expected := Create(2016, time.January, 18, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestTenthFridayOfYear(t *testing.T) {
	...
	expected := Create(2016, time.March, 4, 0, 0, 0, 0, time.UTC)
	assert.Equal(t, expected, t2)
}
...
func TestFirstQuarter(t *testing.T) {
	t1 := Create(2016, time.March, 22, 13, 0, 0, 0, time.UTC)

	assert.EqualValues(t, 1, t1.Quarter())
}

func TestSecondQuarter(t *testing.T) {
	t1 := Create(2016, time.May, 22, 13, 0, 0, 0, time.UTC)
...
func TestAverageGreater(t *testing.T) {
	t1 := Create(2000, time.January, 1, 1, 1, 1, 0, time.UTC)
	t2 := Create(2009, time.December, 31, 23, 59, 59, 0, time.UTC).Average(t1)

	expected := Create(2004, time.December, 31, 12, 30, 30, 0, time.UTC)
	assert.Equal(t, expected, t2)
}

func TestAverageLower(t *testing.T) {
	t1 := Create(2009, time.December, 31, 23, 59, 59, 0, time.UTC)
	t2 := Create(2000, time.January, 1, 1, 1, 1, 0, time.UTC).Average(t1)
...
func TestCreateFromFormat(t *testing.T) {
	loc, _ := time.LoadLocation("Africa/Cairo")
	d, _ := CreateFromFormat(DefaultFormat, "2015-11-02 16:10:22", loc)
...
func TestCreateFromFormatInvalidFormat(t *testing.T) {
	loc, _ := time.LoadLocation("Africa/Cairo")
	_, err := CreateFromFormat(DefaultFormat, "", loc)

	assert.NotNil(t, err)
}

func TestCreateFromTimestampUTC(t *testing.T) {
	c := CreateFromTimestampUTC(1171502725)
...
func TestCreateFromTimestamp(t *testing.T) {
	loc, _ := time.LoadLocation("Africa/Cairo")
	c := CreateFromTimestamp(1171502725, loc)

	expected := Create(2007, time.February, 15, 1, 25, 25, 0, loc)
	assert.Equal(t, expected, c, "The date should be 07-02-15 01:25:25")
}

func TestCreateFromTime(t *testing.T) {
	c := CreateFromTime(10, 10, 10, 10, time.UTC)
